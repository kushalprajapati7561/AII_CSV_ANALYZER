...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-cwx5ztbx12ip-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| HTTP Method | `POST` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-cwx5ztbx12ip-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video",
    {
      method: "POST",
      headers: {
