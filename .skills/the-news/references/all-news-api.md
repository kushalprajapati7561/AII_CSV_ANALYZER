...
**Endpoint:** `GET https://app-cwx5ztbx12ip-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all`
...
async function getAllNews(params: AllNewsParams = {}): Promise<AllNewsResponse> {
  ...
  const response = await fetch(
    `https://app-cwx5ztbx12ip-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
