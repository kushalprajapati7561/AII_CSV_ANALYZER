...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-cwx5ztbx12ip-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-cwx5ztbx12ip-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-cwx5ztbx12ip-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-cwx5ztbx12ip-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-cwx5ztbx12ip-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-cwx5ztbx12ip-api-wL1zlEdVM6DY.gateway.appmedo.com`
