...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-cwx5ztbx12ip-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| HTTP Method | `POST` |
...
async function submitOmniVideo(options: OmniVideoSubmitOptions): Promise<{ taskId: string }> {
  const response = await fetch(
    "https://app-cwx5ztbx12ip-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video",
    {
      method: "POST",
      headers: {
