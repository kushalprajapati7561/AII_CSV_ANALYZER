...
**Endpoint:** `GET https://app-cwx5ztbx12ip-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod`
...
async function getEodData(symbol: string, params: EodParams = {}): Promise<EodResponse> {
  ...
  const response = await fetch(
    `https://app-cwx5ztbx12ip-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod?${query.toString()}`,
