...
**Endpoint:** `GET https://app-cwx5ztbx12ip-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-cwx5ztbx12ip-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
